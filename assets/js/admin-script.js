        ...
        wxp_order_item_shipment:function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    <td class="txt-ltr">'+data.products[i].name+'</td>\
                    <td class="txt-ctr">'+data.products[i].qty+'</td>\
                    <td class="txt-ctr"><input data-item-qty="'+data.products[i].qty+'" data-item-id="'+data.products[i].id+'" data-order-id="'+data.products[i].order_id+'" class="wxp-order-item-shipped" type="number" min="0" max="'+data.products[i].qty+'" step="1" value="'+data.products[i].shipped+'"></td>\
                    </tr>';
                    }
                    html+='</tbody>\
                </table>';
